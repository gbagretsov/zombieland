...
public var brakeLights : GameObject;
...
{		
	...
	speedGUI.text = "Speed: " + Mathf.Floor(Convert_Meters_Per_Second_To_Miles_Per_Hour(relativeVelocity.magnitude));
...
function GetInput()
{
    ...
    brakeLights.gameObject.SetActive(Input.GetKey(KeyCode.S));
